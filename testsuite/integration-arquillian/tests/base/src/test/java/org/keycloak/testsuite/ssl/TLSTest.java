...
public class TLSTest extends AbstractTestRealmKeycloakTest {
    ...
    public static final String AUTH_SERVER_ROOT_WITHOUT_TLS = "http://localhost:" + System.getProperty("auth.server.http.port", "8180");
    ...
    public void testTurningTLSOn() throws Exception {
        //given
        oauth.updateURLs(AUTH_SERVER_ROOT_WITHOUT_TLS);
